    ...
    <div className="h-[800px]">
      <div className="flex flex-col items-center">
        ...
        <div className="flex items-center w-[90%]">
          ...
          ></Image>
          <div className=" flex flex-col items-center h-[400px] w-[600px] absolute bg-[orange] shadow-2xl rounded-3xl right-10 hover:translate-y-[-10px] transition duration-[500ms] ">
